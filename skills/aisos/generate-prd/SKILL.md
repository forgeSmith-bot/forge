...
# PRD Generation Skill (AISOS Edition)

Generate a Product Requirements Document using the template and guidelines below.

## Instructions

1. Read the template from `skills/aisos/generate-prd/prd-template.md`
2. **Write the opening entertainment first** — before anything else in the document:
   a. **Joke**: Write a 2–3 line joke directly about the specific feature being requested. It must reference the actual feature — no generic "why do programmers prefer dark mode" filler.
   b. **Story**: Write a 4–6 sentence funny story about the feature and the people who will use it. Structure it as a micro-fable: a specific character runs into the pain point this feature solves, something absurd happens, and it ends with a punchline or wry moral.
...
4. Analyze the raw requirements provided, combined with any content extracted from attachments
...
- [ ] Opening joke is specific to the feature (not a recycled generic joke)
- [ ] Funny story has a named character, a clear pain point, and a punchline or moral
...
Follow the structure in `skills/aisos/generate-prd/prd-template.md` exactly.
